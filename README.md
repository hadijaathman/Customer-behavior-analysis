...
- Used filtering, grouping, sorting, joins, and aggregation functions.

### 5. Power BI Dashboard
- Connected Power BI to the processed data.
- Built interactive dashboards.
- Created charts, KPIs, and filters.

### 6. Report and Presentation
- Prepared a report summarizing the analysis and findings.
...
6. Open the Power BI (.pbix) dashboard.
